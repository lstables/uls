<?php
/**
 * File for class ULSStructEAUser_Login
 * @package ULS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ULSStructEAUser_Login originally named EAUser_Login
 ...
 * @date 2016-10-18
 */
class ULSStructEAUser_Login extends ULSWsdlClass
{
    /**
     * The SID
     * Meta informations extracted from the WSDL
    ...
    public $EAUserCode;
    /**
     * Constructor method for EAUser_Login
     * @see parent::__construct()
     * @param string $_sID
     * @param string $_eAUserCode
     * @return ULSStructEAUser_Login
     */

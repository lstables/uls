<?php
/**
 * File for ULSWsdlClass to communicate with SOAP service
 * @package ULS
 ...
 */
/**
 * ULSWsdlClass to communicate with SOAP service
 * Documentation : Conveyancing Web Services - Security & Session Management v1.08
 * @package ULS
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2016-10-18
 */
class ULSWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://ekacws-qa.utdgroup.com/v1_08/security.asmx?wsdl'; //'https://ekacws.utdgroup.com/v1_08/security.asmx?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses ULSWsdlClass::setLastError()
     * @uses ULSWsdlClass::initSoapClient()
     * @uses ULSWsdlClass::initInternArrayToIterate()
     * @uses ULSWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'ULSWsdlClass'))
            {
     ...
     * @uses ULSClassMap::classMap()
     * @uses ULSWsdlClass::getDefaultWsdlOptions()
     * @uses ULSWsdlClass::getSoapClientClassName()
     * @uses ULSWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('ULSClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = ULSClassMap::classMap();
     ...
     * If a class is named as {ULS}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('ULSSoapClient') && is_subclass_of('ULSSoapClient','SoapClient'))
            return 'ULSSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses ULSWsdlClass::WSDL_CACHE_WSDL
     * @uses ULSWsdlClass::WSDL_COMPRESSION
     * @uses ULSWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses ULSWsdlClass::WSDL_ENCODING
     * @uses ULSWsdlClass::WSDL_EXCEPTIONS
     * @uses ULSWsdlClass::WSDL_FEATURES
     * @uses ULSWsdlClass::WSDL_LOGIN
     * @uses ULSWsdlClass::WSDL_PASSWORD
     * @uses ULSWsdlClass::WSDL_SOAP_VERSION
     * @uses ULSWsdlClass::WSDL_STREAM_CONTEXT
     * @uses ULSWsdlClass::WSDL_TRACE
     * @uses ULSWsdlClass::WSDL_TYPEMAP
     * @uses ULSWsdlClass::WSDL_URL
     * @uses ULSWsdlClass::VALUE_WSDL_URL
     * @uses ULSWsdlClass::WSDL_USER_AGENT
     * @uses ULSWsdlClass::WSDL_PROXY_HOST
     * @uses ULSWsdlClass::WSDL_PROXY_PORT
     * @uses ULSWsdlClass::WSDL_PROXY_LOGIN
     * @uses ULSWsdlClass::WSDL_PROXY_PASSWORD
     * @uses ULSWsdlClass::WSDL_LOCAL_CERT
     * @uses ULSWsdlClass::WSDL_PASSPHRASE
     * @uses ULSWsdlClass::WSDL_AUTHENTICATION
     * @uses ULSWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses ULSWsdlClass::getSoapClient()
     * @uses ULSWsdlClass::getFormatedXml()
     ...
     * @uses ULSWsdlClass::getSoapClient()
     * @uses ULSWsdlClass::convertStringHeadersToArray()
     ...
     * @uses ULSWsdlClass::getInternArrayToIterate()
     * @uses ULSWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses ULSWsdlClass::getInternArrayToIterateOffset()
     * @uses ULSWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses ULSWsdlClass::getInternArrayToIterateOffset()
     * @uses ULSWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @uses ULSWsdlClass::getAttributeName()
     * @uses ULSWsdlClass::__toString()
     * @uses ULSWsdlClass::_set()
     * @uses ULSWsdlClass::_get()
     * @uses ULSWsdlClass::setInternArrayToIterate()
     * @uses ULSWsdlClass::setInternArrayToIterateIsArray()
     * @uses ULSWsdlClass::setInternArrayToIterateOffset()

<?php
/**
 * File for class ULSStructSession_End
 * @package ULS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ULSStructSession_End originally named Session_End
 ...
 * @date 2016-10-18
 */
class ULSStructSession_End extends ULSWsdlClass
{
    /**
     * The SID
     * Meta informations extracted from the WSDL
    ...
    public $SID;
    /**
     * Constructor method for Session_End
     * @see parent::__construct()
     * @param string $_sID
     * @return ULSStructSession_End
     */

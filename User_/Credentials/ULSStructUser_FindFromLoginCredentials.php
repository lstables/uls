<?php
/**
 * File for class ULSStructUser_FindFromLoginCredentials
 * @package ULS
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ULSStructUser_FindFromLoginCredentials originally named User_FindFromLoginCredentials
 ...
 * @date 2016-10-18
 */
class ULSStructUser_FindFromLoginCredentials extends ULSWsdlClass
{
    /**
     * The SID
     * Meta informations extracted from the WSDL
    ...
    public $Password;
    /**
     * Constructor method for User_FindFromLoginCredentials
     * @see parent::__construct()
     * @param string $_sID
     * @param string $_username
     * @param string $_password
     * @return ULSStructUser_FindFromLoginCredentials
     */
